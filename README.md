...
It is use to you how you use these in your checkers. The best way I've found is to take in a username password pair as an argument. Then I can declare
a service like so:
```yaml
...
in the admin page at runtime. Services, Teams, Injects, Passwords, and Saveing/Loading functionality can all be found there.
